    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deleted', models.DateTimeField(auto_now=True, help_text='Date time on which the object was delete.', verbose_name='deleted at')),
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('name', models.CharField(max_length=100, unique=True, verbose_name='name of event')),
                ('date', models.DateTimeField(blank=True, null=True, verbose_name='date of event')),
                ('description', models.CharField(max_length=500, verbose_name='description of event')),
                ('url', models.URLField(verbose_name='autogenerate url of event')),
                ('banner_title', models.CharField(blank=True, max_length=300, verbose_name='title to search in dashboard about of the specific event')),
                ('banner_img', models.ImageField(blank=True, null=True, upload_to='event/banner/', verbose_name='banner of event')),
                ('code', models.BigIntegerField(editable=False, unique=True, verbose_name='code of the party (Share and more)')),
